...
def plot_access_timeline(timeline_dates, timeline_ips):
    ...
    plt.tight_layout()
    plt.savefig("/home/brares/public_html/access_timeline.png", bbox_inches='tight')
...
def plot_error_timeline(grouped_errors):
    ...
    plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%d-%b %H:%M'))
    plt.tight_layout()
    plt.savefig("/home/brares/public_html/timelines_grouped.png", bbox_inches='tight')
...
def plot_error_ip(grouped_errors):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("/home/brares/public_html/timelines_ip.png", bbox_inches='tight')
...
def plot_ip_frequency(ip_counts):
    ...
    plt.xticks(rotation=45)
    plt.tight_layout()
    plt.savefig("/home/brares/public_html/ip_grouped.png", bbox_inches='tight')
...
def plot_page_frequency(access_logs):
    ...
    plt.tight_layout()
    plt.savefig("/home/brares/public_html/page_access_frequency.png", bbox_inches='tight')
...
def plot_page_browser(access_logs):
    ...
    plt.tight_layout()
    plt.savefig("/home/brares/public_html/page_access_browser.png", bbox_inches='tight')
...
def plot_page_frequency(access_logs):
    ...
    plt.tight_layout()
    plt.savefig("/home/brares/public_html/page_access_ip.png", bbox_inches='tight')
...
def plot_ip_browser_diagram(grouped_browsers):
    ...
    plt.xlabel('IP Address')
    plt.ylabel('Browser')
    plt.savefig("/home/brares/public_html/ip_browser.png", bbox_inches='tight')
...
def main():
    ...
    ax0.axis('off')  # Turn off the axisS
